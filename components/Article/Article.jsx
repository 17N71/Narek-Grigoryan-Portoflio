  ...
  xl:text-3xl text-xl md:text-2xl
   device:pr-24 text-stone-700 dark:text-white/70"
      ...
      font-black transition-color duration-300 "
        ...
        <a
          target="_blank"
          className="px-1 outline-none tracking-wider hover:text-[#38bdf8]  font-black transition-color duration-300"
        ...
        <a
          target="_blank"
          className="px-1 outline-none tracking-wider hover:text-black hover:bg-white rounded-md font-extrabold transition-color duration-300 "
        ...
        <a
          ...
          rel="noopener noreferrer nofollow"
          className="hover:text-[#bf4080]  font-black transition-color duration-300 "
        >
          {par[lang][5]}
        </a>
        {par[lang][6]}
